...
Config.Tuning = {
  ...
  engineSwaps = {
    [1] = {
      name = "I4 Turbo 2.5L",
      icon = "engine.svg",
      info = "Motor 2.5L biturbo. Pode alcançar velocidades de até 100 mph!",
      itemName = "i4_engine",
      price = 30000,
    ...
    [2] = {
      ...
      info = "Motor V6 preparado - capaz de alcançar até 120 mph.",
      itemName = "v6_engine",
      price = 45000,
      handlingOverwritesValues = true,
      handlingApplyOrder = 1,
    ...
    [3] = {
      name = "V8 6.5L",
      icon = "engine.svg",
      info = "V8 6.5L aspirado. Tem ótimos estouros e um ronco marcante quando você alivia o acelerador. Vai impressionar.",
      itemName = "v8_engine",
      price = 65000,
    ...
    [4] = {
      name = "V12 6.0L",
      icon = "engine.svg",
      info = "Um monstro V12 6.0L. Pode passar de 130 mph; seja realista e instale apenas em veículos que realmente comportem um V12.",
      itemName = "v12_engine",
      price = 80000,
  ...
  brakes = {
    [1] = {
      name = "Cerâmico",
      icon = "brakes.svg",
      info = "Freios potentes com enorme capacidade de frenagem",
