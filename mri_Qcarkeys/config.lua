...
Config.Locale = {
    ...
    lockpickCooldown = 'Aguarde um momento antes de tentar novamente.',
    lockpickDisabled = 'O sistema de lockpick está desativado.',
    lockpickRegressed = 'Você perdeu progresso no lockpick.',
    mustBeDriver = 'Você precisa estar no banco do motorista.',
